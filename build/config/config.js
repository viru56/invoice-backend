...
exports.applicationData = {
    ...
    responseMessages: {
        accountCreation: {
            message1: "your account is created, please check your mail to set up new password."
        },
        accountActivation: {
            message1: "user account is created and send a mail to set password"
        },
        forgotPassword: {
            mailSent: "If the supplied email address is associated with a user account then a password reset email has been sent.",
            passwordChanged: "Your password is changed successfully. Now login with your new password."
        },
        error: {
